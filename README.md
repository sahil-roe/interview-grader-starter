...
1. **Reference answers** — Users can add or update the reference answer for a job. Decide how this should be represented in the database and expose the API needed by the frontend.
...
4. **Text similarity grader** — Implement scoring based on string similarity between the model output and reference answer. Support at least fuzzy matching and one n-gram overlap metric (BLEU, ROUGE, or METEOR).
